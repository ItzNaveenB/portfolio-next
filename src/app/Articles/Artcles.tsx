...
const Articles = () => {
  return (
    <div className="mx-4 md:mx-[9rem] mt-16">
      ...
      <Link className="flex w-full md:w-[20%] p-2 rounded-full border border-gray-400 mx-auto mt-10 justify-center items-center hover:bg-slate-200 hover:text-black" href="/articles">See all articles</Link>
    </div>
  );
};
